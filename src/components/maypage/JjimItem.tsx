...
export default function JjimItem() {
  return (
    <a className={styles.jjim_item_container} href={'/detail/:productId'}>
      ...
      <span className={styles.jjim_item_title}>젤다 젤다 왕눈!왕국의 눈물!</span>
      <span className={styles.jjim_item_price}>74,800원</span>
    </a>
  )
}
